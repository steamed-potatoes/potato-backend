...
public class BoardController {
    ...
    public ApiResponse<List<BoardWithCreatorInfoResponse>> retrievePublicLatestBoardList(@Valid RetrievePublicLatestBoardsRequest request) {
    ...
    public ApiResponse<BoardWithCreatorInfoResponse> getDetailBoard(@PathVariable Long boardId) {
